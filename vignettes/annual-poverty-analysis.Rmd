...
Load stacked quarterly PNADC data and run the mensalization algorithm:
...
### Example 3: Post-hoc Smoothing

The raw monthly series may show quarterly artifacts from IBGE's rotating panel design. If artifacts persist after weight calibration (which applies smoothing by default), you can apply additional post-hoc smoothing:
