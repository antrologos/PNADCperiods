...
This vignette shows two strategies for proper variance estimation with the monthly weights from `PNADCperiods`:
...
# Filter to determined observations (those with identified reference months)
pnadc_monthly <- pnadc[determined_month == TRUE]
```
