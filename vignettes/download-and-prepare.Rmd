...
Crosswalk complete:
  ...
  - Fortnight determination: 6.8%
  - Week determination: 1.6%
```
...
The distribution is approximately equal across months 1, 2, and 3 (each around 31-32%), with 5.4% having `NA` for indeterminate cases (this is higher than the ~3% seen with full 2012-2025 data because boundary quarters have lower determination rates).
