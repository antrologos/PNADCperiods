...
|----------|-------------|--------|-------|
| Strict only | ~7% | ~1.5% | Definitive determinations only |
| + Probabilistic | ~14% | ~2% | Adds confidence scores |
| + UPA aggregation | ~58% | ~14% | Leverages 100% UPA homogeneity |
...
| Fortnight rate (+ experimental) | **~60%** |
| Week rate (+ experimental) | **~15%** |
