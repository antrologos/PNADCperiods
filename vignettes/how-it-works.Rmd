...
| **Function** | `mensalizePNADC()` | `mensalize_annual_pnadc()` |
...
The `mensalize_annual_pnadc()` function follows this algorithm:
...
- Package function reference: `?mensalizePNADC`, `?mensalize_annual_pnadc`
